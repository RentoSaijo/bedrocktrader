...
Set `expanded = TRUE` to separate modeled enchantments and other generated
outcomes:
...
rows, while an expanded option describes one enchantment set, color, effect,
or other modeled outcome from its source trade.
